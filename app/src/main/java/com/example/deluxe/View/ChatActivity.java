...
public class ChatActivity extends AppCompatActivity implements ChatInterface.ChatView {
    ...
    public void init()
    {
        ...
        this.receiver = (TextView) findViewById(R.id.emailReceiver);
        this.content = (EditText) findViewById(R.id.contentMessage);

        this.recyclerView = (RecyclerView) findViewById(R.id.listMessage);
